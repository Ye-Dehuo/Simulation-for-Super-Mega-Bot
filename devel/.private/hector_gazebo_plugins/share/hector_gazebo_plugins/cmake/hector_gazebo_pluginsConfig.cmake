...
if(NOT "/home/zyx/GZKJ/ETH_SMB_2/devel/.private/hector_gazebo_plugins/include;/home/zyx/GZKJ/ETH_SMB_2/src/hector_gazebo/hector_gazebo_plugins/include " STREQUAL " ")
  set(hector_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/zyx/GZKJ/ETH_SMB_2/devel/.private/hector_gazebo_plugins/include;/home/zyx/GZKJ/ETH_SMB_2/src/hector_gazebo/hector_gazebo_plugins/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zyx/GZKJ/ETH_SMB_2/src/hector_gazebo/hector_gazebo_plugins/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zyx/GZKJ/ETH_SMB_2/devel/.private/hector_gazebo_plugins/lib;/home/zyx/GZKJ/ETH_SMB_2/devel/lib;/home/zyx/catkin_ws/devel/lib;/opt/ros/noetic/lib)
