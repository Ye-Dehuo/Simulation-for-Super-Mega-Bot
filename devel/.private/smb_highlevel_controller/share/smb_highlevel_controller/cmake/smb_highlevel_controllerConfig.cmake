...
if(NOT "/home/zyx/GZKJ/ETH_SMB_2/src/smb_highlevel_controller/include " STREQUAL " ")
  set(smb_highlevel_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/zyx/GZKJ/ETH_SMB_2/src/smb_highlevel_controller/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'smb_highlevel_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zyx/GZKJ/ETH_SMB_2/src/smb_highlevel_controller/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zyx/GZKJ/ETH_SMB_2/devel/.private/smb_highlevel_controller/lib;/home/zyx/GZKJ/ETH_SMB_2/devel/lib;/home/zyx/catkin_ws/devel/lib;/opt/ros/noetic/lib)
